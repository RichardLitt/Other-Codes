...
Example structures:
    ...
    ox*.csv:
    2012-01-26 18:30:00.000000, coding, 2012-01-26 19:30:00.000000, 1:00:00, \ 
    coding, Added this line, 22.
    start, project, end, time, project, comment, PID-complete.


    tasks.csv:
    research, Read research papers., 01:00:00, 2012-09-16, 1, 1, hard, 22
    project, task, expected time, date due, weighting, days to work on, cat,
    PID
'''
...
def help():
    ...
    print " test"
    print
    print " write (Hours and minutes, or today optional)"
...
def today():
    ...
    try:
        if sys.argv[2] == "tasks":
            ...
            print
            print "According to tasks, today you must:"
            ...
            for x in range(len(to_do_today)):
                ...
                print " %s %s for %s for %s." % (PID, line[1], line[0], \
